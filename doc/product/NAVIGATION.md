...
```text
┌──────────────────────────┬────────────────────────────────────────────────────────────────────────────────────────────────┐
│ 解决方案                  │ ICON 智能制造解决方案        │ ICON 智慧储能解决方案        │ ICON 智慧水利/水务解决方案 │ ICON 智慧教育解决方案     │
│                          │      融合设备、数据与智能生产 │      驱动储能安全、高效与    │      感知水务全域，        │      AI赋能教学、        │
│ 多行业场景解决方案         │                             │      智能运营               │      智能调度运营          │      管理与学习          │
│ 赋能企业AI落地            ├─────────────────────────────┼─────────────────────────────┼───────────────────────────┼─────────────────────────┤
│                          │ ICON FDE解决方案 [hot]       │ ICON 算电协同运营方案 [hot]  │ ICON 零碳园区智能化解决方案 │ ICON AI+供应链解决方案     │
│ 涵盖30+的应用场景，        │      深入业务现场，          │      统筹算力、电力、        │      协同能源、设备        │      AI驱动供应链预测      │
│ 以数据与知识底座桥接        │      让AI真正落地            │      冷却与储能              │      与园区运营            │      与协同决策            │
│ 企业业务与人工智能         │                             │                             │                           │                          │
└──────────────────────────┴─────────────────────────────┴─────────────────────────────┴───────────────────────────┴─────────────────────────┘
```
- 左侧为主标题 + 两行描述；右侧 4×2 卡片网格，卡片间距 16px。
