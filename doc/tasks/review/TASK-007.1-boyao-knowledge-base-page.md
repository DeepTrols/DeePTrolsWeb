...
| Review 修复提交 | `8430741` nowrap 约束、`eb6718f` hero 视觉与核心价值动画对齐、`68d9d45` service-showcase 迁移、`94ee4ab` hero 模块纯 ICON、`1fb8b52` IsoCube 顶面尺寸修复、`d19ede8` hero 圆角与背景 1:1、`2cad87a` IsoCube 白线修复 |
