...
import { caseHero } from '~/data/cases'
</script>

<template>
  <section class="relative h-[586px] overflow-hidden bg-black" aria-labelledby="case-hero-title">
    <video
    ...
    <div class="container relative h-full">
      ...
      <div
        class="absolute left-0 top-[clamp(132px,16.67vw,320px)] w-[min(760px,100%)] max-w-full max-md:top-[250px]"
      >
