...
import { manufacturingHero } from '~/data/solutions/manufacturing'
</script>

<template>
  <section class="relative h-[586px] overflow-hidden bg-[#1f49e5]" aria-labelledby="manufacturing-hero-title">
    <img
