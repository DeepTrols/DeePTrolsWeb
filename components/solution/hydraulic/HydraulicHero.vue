...
import { hydraulicHero } from '~/data/solutions/hydraulic'
</script>

<template>
  <section class="relative h-[586px] overflow-hidden bg-[#1f49e5]" aria-labelledby="hydraulic-hero-title">
    <img
      class="absolute inset-0 h-full w-full object-cover object-center"
      :src="hydraulicHero.image"
      :alt="hydraulicHero.imageAlt"
    />
    <div
