...
import { educationHero } from '~/data/solutions/education'
</script>

<template>
  <section class="relative h-[586px] overflow-hidden bg-[#1f49e5]" aria-labelledby="education-hero-title">
    <img
      class="absolute inset-0 h-full w-full object-cover object-center"
      :src="educationHero.image"
      :alt="educationHero.imageAlt"
    />
    <div
