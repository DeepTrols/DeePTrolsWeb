...
const nodes: Node[] = [
  ...
  { id: 'stage-adapt', type: 'flowmq', position: { x: 260, y: 117 }, data: { kind: 'stage', label: '协议接入', subtitle: 'Protocol Adapter', icon: Cable, sizeClass: 'size-[120px]' }, selectable: false, draggable: false },
  { id: 'stage-route', type: 'flowmq', position: { x: 480, y: 117 }, data: { kind: 'stage', label: '统一路由', subtitle: 'Unified Router', icon: Route, sizeClass: 'size-[120px]' }, selectable: false, draggable: false },
  { id: 'stage-deliver', type: 'flowmq', position: { x: 700, y: 117 }, data: { kind: 'stage', label: '多模投递', subtitle: 'Multi-mode Delivery', icon: GitFork, sizeClass: 'size-[120px]' }, selectable: false, draggable: false },
