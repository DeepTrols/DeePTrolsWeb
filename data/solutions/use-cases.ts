...
const seeds: UseCaseSeed[] = [
  ...
  },
  {
    ...
    label: '算力中心',
    gradient: 'AI算力基础设施建设',
    description: '面向海外 AI 服务器供应、算力中心建设与交付场景，提供从规划选型、工程建设到上线运营的一体化算力基础设施服务。',
    icon: Cpu,
    stats: [
      { value: '海外', label: 'AI 服务器供应' },
      { value: '一体化', label: '算力中心建设' },
      { value: '交付', label: '上线运营保障' },
    ],
    values: [
      { title: '算力供给稳定', description: '围绕训练与推理负载规划服务器、网络与存储配置。', icon: Cpu },
      { title: '建设过程可控', description: '覆盖选址、选型、机房施工与设备部署全流程管理。', icon: ClipboardCheck },
      { title: '交付质量可验', description: '通过联调测试、性能验证与验收标准确认交付结果。', icon: BadgeCheck },
      { title: '运营成本可优', description: '结合能耗、调度与运维策略持续优化算力使用成本。', icon: Gauge },
    ],
    approach: [
      {
        category: '数据接入',
        title: '梳理算力需求与资源现状',
        description: '结合训练、推理与业务负载需求，评估服务器、网络、机房与运维资源现状。',
        bullets: ['算力负载需求分析', '服务器与配套设施选型', '机房与电力资源评估'],
      },
      {
        category: '算力建设',
        title: '建设算力中心与配套环境',
        description: '完成海外服务器供应、机房改造、网络互联与存储部署，形成可用算力底座。',
        bullets: ['服务器采购与到货验收', '机房施工与设备安装', '网络互联与存储部署'],
      },
      {
        category: '智能调度',
        title: '支撑算力调度与运营优化',
        description: '将算力资源接入统一管理平台，支撑任务调度、监控告警与成本分析。',
        bullets: ['资源池化与统一纳管', '任务调度与负载监控', '能耗与成本分析优化'],
      },
    ],
    architectureCards: [
      { title: '设施供应层', description: '覆盖海外 AI 服务器、网络与存储设备的供应与验收。' },
      { title: '机房建设层', description: '支撑选址、电力、制冷、布线与设备安装工程建设。' },
      { title: '调度运营层', description: '提供资源纳管、任务调度、监控告警与成本分析能力。' },
    ],
    capabilities: [
      { title: '服务器供应', description: '提供海外 AI 服务器选型、采购与交付服务。', icon: Cpu },
      { title: '机房工程建设', description: '覆盖选址、电力、制冷、消防与综合布线施工。', icon: Building2 },
      { title: '网络与存储部署', description: '构建高性能计算网络与分布式存储体系。', icon: Network },
      { title: '联调与验收', description: '执行设备联调、性能测试与交付验收标准。', icon: ClipboardCheck },
      { title: '资源统一纳管', description: '将服务器、网络与存储纳入统一资源管理。', icon: Database },
      { title: '运维与成本优化', description: '监控算力运行状态，优化能耗与使用成本。', icon: Gauge },
    ],
    showcase: [
      { title: '算力中心建设交付', description: '从规划设计到施工验收的端到端工程建设服务。', icon: Building2 },
      { title: 'AI 服务器供应', description: '面向训练与推理场景的海外服务器供应与部署。', icon: Cpu },
      { title: '算力运营支持', description: '提供资源纳管、监控告警与成本优化运营服务。', icon: Activity },
    ],
    visualTitle: 'AI Computing Infrastructure',
    visualSubtitle: '供应、建设、交付与运营一体化',
  },
  {
