...
export const footerColumns: FooterColumn[] = [
  {
    ...
    groups: [
      [
        ...
        { label: '博曜·企业级知识管理平台', href: '/products/knowledge-base' },
      ],
      [
        { label: '探曜·AI物联感知平台', href: '/products/ai-iot' },
        { label: 'Device Agent', href: '/products/device-agent' },
      ],
      [
        { label: 'API安全管控平台', href: '/products/api-security' },
        { label: 'API安全审计系统', href: '/products/api-audit' },
        { label: '业务威胁感知系统', href: '/products/threat-sensing' },
      ],
    ],
  },
  {
  ...
  },
  {
    ...
    groups: [
      [
        ...
        { label: '智能体社区', href: '/community', arrow: true },
      ],
    ],
  },
  {
