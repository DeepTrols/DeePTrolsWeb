...
assert(
  runtimeContextPanel.includes('title="设备上下文引擎"') &&
    ...
    runtimeContextPanel.includes('mt-5 grid min-h-0 flex-1 grid-cols-2 gap-2 sm:gap-3 xl:grid-cols-4 xl:flex-none') &&
    runtimeContextPanel.includes('mt-5 flex items-center gap-2') &&
    ...
    runtimeContextPanel.includes('mt-5 rounded-xl border border-dt-line-strong/60 bg-dt-bg p-2.5') &&
