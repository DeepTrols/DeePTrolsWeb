export function checkServiceReportContracts(ctx) {
  ...
  assert(
    reportFeaturedSection.includes('class="container"') &&
  ...
  assert(
    reportResourcesSection.includes('class="container"') &&
      reportResourcesSection.includes('class="flow-root pb-32 lg:pb-44"') &&
