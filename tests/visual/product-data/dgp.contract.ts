...
export function registerDgpVisualContracts() {
  it('keeps the DGP product page aligned with its requirement document', () => {
    ...
    expect(evolution).toContain('class="container"')
    ...
    expect(evolution).toContain('DgpEvolutionVisual')
    expect(evolution).toContain('核心能力动画')
    expect(evolution).not.toContain('图片占位符')
