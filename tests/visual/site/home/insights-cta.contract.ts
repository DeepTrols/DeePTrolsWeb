...
export function registerHomeInsightsCtaVisualContracts() {
  it('keeps HOME insights and CTA contracts', () => {
    ...
    expect(ctaSection).toContain('padding-bottom: var(--dt-space-section)')
    expect(ctaSection).toContain('padding-bottom: var(--dt-space-section-lg)')
    expect(ctaSection).toContain('font-size: 35px')
    expect(ctaSection).toContain('font-size: 15px')
