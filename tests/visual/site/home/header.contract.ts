...
export function registerHomeHeaderVisualContracts() {
  it('keeps HOME header rhythm and navigation contracts', () => {
    ...
    expect(header).toContain('isProductRoute')
    expect(header).toContain('is-product-page')
    ...
    expect(siteHeaderStyles).toContain('.site-header.is-product-page.is-at-top:not(.has-mega):not(.has-mobile) .site-header__nav-button.active:not(:hover):not(:focus-visible):not([data-state="open"])')
    expect(siteHeaderStyles).toContain('.site-header.is-product-page.is-at-top:not(.has-mega):not(.has-mobile) .site-header__nav-underline')
    expect(siteHeaderStyles).not.toContain('background: rgba(0, 0, 0, 0.4)')
    expect(siteHeaderStyles).not.toContain('.site-header:not(.is-home)')
    ...
    expect(megaPanelProduct).toContain('mega-col--links')
    expect(megaPanelProduct).toContain('@mouseenter="activeColumn = index"')
    expect(megaPanelProduct).not.toContain('padding-right: 44px')
    expect(megaPanelProduct).toContain('top: -4px')
