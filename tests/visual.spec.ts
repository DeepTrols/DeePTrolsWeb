...
describe('visual implementation contract', () => {
  ...
  it('keeps the DMS product page aligned with its requirement document', () => {
    ...
    expect(hero).toContain('title-line="让数据流通更安全、更可信"')
    ...
    expect(businessValue).toContain('SectionHeader')
    ...
    expect(businessValue).toContain('rounded-2xl border border-default bg-default p-7')
