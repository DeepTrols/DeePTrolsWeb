...
describe('visual implementation contract', () => {
  ...
  it('includes responsive navigation and mobile product fallback', () => {
    ...
    expect(readComponent('components/common/ProductSystemSection.vue')).toContain('product-system__mobile-flow')
  })
  ...
  it('keeps EMQX-inspired homepage rhythm contracts', () => {
    ...
    expect(productSystem).toContain('<EnterpriseFlow />')
    ...
    expect(productSystemSection).toContain('role="img"')
    expect(productSystem).toContain('desktop-flow-label="DeepTrols OPS platform architecture"')
    expect(productSystemSection).toContain('height: 560px')
    expect(productSystemSection).toContain('rgba(148, 163, 184, 0.12) 1px')
    expect(productSystemSection).toContain('background-size: 48px 48px')
    expect(productSystemSection).toContain('grid-template-columns: repeat(4, minmax(0, 1fr))')
    expect(productSystemSection).toContain('class="product-system__card dt-product-card"')
    expect(productSystemSection).toContain('class="product-system__card-accent dt-product-card__accent"')
    expect(productSystemSection).toContain('class="product-system__card-icon dt-icon-box"')
    expect(productSystemSection).toContain('product-system__card-accent')
    expect(productSystemSection).toContain('<h3>{{ card.name }}</h3>')
    expect(productSystemSection).not.toContain('{{ card.title }}')
