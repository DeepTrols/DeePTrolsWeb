...
describe('visual implementation contract', () => {
  ...
  it('keeps the DGP product page aligned with its requirement document', () => {
    ...
    expect(featureGrid).toContain('class="size-6"')
    expect(featureGrid).toContain('text-base leading-relaxed')
  ...
  it('keeps EMQX-inspired homepage rhythm contracts', () => {
    ...
    expect(productSystemSection).toContain('.product-system :deep(.section-heading)')
