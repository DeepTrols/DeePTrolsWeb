...
describe('visual implementation contract', () => {
  ...
  it('keeps the Why DeepTrols page on the shared HOME baseline', () => {
    ...
    expect(heroLogoStrip).toContain('class="hero-logo-strip mt-24 border-t border-dt-line pt-12 lg:mt-28"')
    expect(pageHero).toContain('class="page-hero relative overflow-hidden bg-dt-bg"')
    expect(pageHero).toContain('container page-hero__body relative pt-24 pb-24 lg:pt-32 lg:pb-32')
