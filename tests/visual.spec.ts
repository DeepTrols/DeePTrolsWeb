...
describe('visual implementation contract', () => {
  ...
  it('keeps the DGP product page aligned with its requirement document', () => {
    ...
    expect(featureGrid).toContain('dt-card dt-card--adaptive dt-card--feature')
    expect(featureGrid).toContain('dt-card__accent')
    expect(featureGrid).toContain('dt-icon-box dt-icon-box--gradient')
    ...
    expect(systemCards).toContain('dt-card dt-card--adaptive dt-card--feature')
    ...
    expect(evolution).toContain('class="dt-card p-6 backdrop-blur-xl"')
  ...
  it('keeps the Why DeepTrols page on the shared HOME baseline', () => {
    ...
    expect(trustTabsSection).toContain('dt-product-card dt-card--adaptive !p-7 lg:!p-8')
    expect(trustTabsSection).not.toContain('min-h-[280px]')
    expect(trustTabsSection).toContain('dt-icon-box !size-10')
    expect(trustTabsSection).not.toContain('!rounded-xl')
    expect(trustTabsSection).toContain(':size="20"')
    ...
    expect(serviceShowcaseSection).toContain('service-showcase__item dt-card dt-card--soft')
    ...
    expect(engineLinksSection).toContain('engine-links-section__link dt-card dt-card--soft')
    expect(engineLinksSection).toContain('engine-links-section__link-icon dt-icon-box')
  ...
  it('keeps EMQX-inspired homepage rhythm contracts', () => {
    ...
    expect(productSystemCards).toContain('class="product-system__card dt-product-card dt-card--adaptive"')
